                ...
                <div className="card-glass">
                    ...
                    <div className="metric-widget">
                        ...
                        <div className="metric-info">
                            ...
                            <button className="btn btn-outline" style={{ padding: '0.2rem 0.5rem', fontSize: '0.75rem', marginTop: '0.5rem' }}>Top Up</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid-main-side">
                <div>
                    ...
                    <div className="item-row">
                        ...
                        <button className="btn btn-outline" onClick={() => setCurrentView('orders')} style={{ fontSize: '0.8rem', padding: '0.4rem 0.8rem' }}>Review (420kg max)</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="alert alert-warning" style={{ flexDirection: 'column' }}>
                        ...
                        <button className="btn btn-primary" style={{ marginTop: '0.75rem', width: '100%', justifyContent: 'center' }} onClick={() => setCurrentView('planner')}>Review Demand Planner</button>
                    </div>
